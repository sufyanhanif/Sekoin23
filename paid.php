...
$id = $_GET['id'];
$pembelian = http_request("http://localhost/sekoin/read.php?id=$id");
$dataPembelian = json_decode($pembelian, TRUE);

if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $url = 'http://localhost/sekoin/update.php';
    $data = array(
        'id' => $id,
        'status' => 'Paid'
    );
    ...
    if ($response !== false && $httpStatus == 200) {
        ...
        header("Location: http://localhost/sekoin/paid.php?id=$id");
        exit;
    } else {
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label>Email</label>
                                <p class="form-control">
                                    <?=$dataPembelian[0]['email'];?>
                                </p>
                            </div>
                            <div class="mb-3">
                                <label>Nama</label>
                                <p class="form-control">
                                    <?=$dataPembelian[0]['name'];?>
                                </p>
                            </div>
                            <div class="mb-3">
