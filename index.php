...
<body>
        ...
        ?>
    <div class="container">
        <h1 class="mt-5">SEKOIN 2023</h1>
        <div class="card mt-4 order-summary">
        <div class="card-body">
            <div class="centered-image">
                <div class="rounded-image">
                    <img src="sekoin23.jpeg" alt="Logo" width="300" height="300">
                </div>
            </div>
            <br>
            <h5 class="card-title">Tutorial Mendaftar</h5>
                <a>1. Masukan Email dan nama</a>
                <br>
                <a>2. Pilih produk yang diinginkan</a>
                <br>
